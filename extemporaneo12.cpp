...
int fibonacchi(int x) {//Funcion de fibonacci
    ...
    unsigned long long aux = 1, fib = 0, CantidadNum = x, init;// asignaciones principales de los numeros donde comienza la serie
   
    for (init = 1; init <= CantidadNum; init++) { // ciclo donde se evalua, comienza con 0 y 1 y se repite hasta la
